...
const Contact = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-secondary/20">
      <SEO 
        title="Contact Us - Pokemon Go CP Calculator Support & Feedback"
        description="Contact the Pokemon Go CP Calculator team for support, feedback, or suggestions. We respond within 48 hours and value your input to improve our tools."
        canonical="https://pokemongocpcalculator.com/contact"
