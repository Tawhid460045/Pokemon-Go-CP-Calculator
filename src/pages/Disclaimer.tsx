...
const Disclaimer = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-secondary/20">
      <SEO 
        title="Disclaimer - Pokemon Go CP Calculator | Terms & Conditions"
        description="Read our disclaimer for Pokemon Go CP Calculator. Educational tool not affiliated with Niantic. Understand accuracy limitations and proper usage guidelines."
        canonical="https://pokemongocpcalculator.com/disclaimer"
      ...
      <div className="container mx-auto px-4 py-12 md:py-20">
        <div className="relative bg-white dark:bg-card border border-border rounded-2xl p-6 md:p-8 shadow-sm">
          ...
          <div className="prose dark:prose-invert max-w-none">
            ...
            <p>Pokémon is Copyright Gamefreak, Nintendo, and The Pokémon Company 2001-2025. All images and names owned and trademarked by Gamefreak, Nintendo, The Pokémon Company, and Niantic are property of their respective owners.</p>
