...
const Privacy = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-background to-secondary/20">
      <SEO 
        title="Privacy Policy - Pokemon Go CP Calculator | Data Protection"
        description="Read our Privacy Policy to understand how Pokemon Go CP Calculator protects your data. We don't collect personal information and operate entirely in your browser."
        canonical="https://pokemongocpcalculator.com/privacy"
      ...
      <div className="container mx-auto px-4 py-12 md:py-20">
        <div className="relative bg-white dark:bg-card border border-border rounded-2xl p-6 md:p-8 shadow-sm">
          ...
          <div className="prose dark:prose-invert max-w-none">
            ...
            <p>Our website may use third-party services, such as Google Analytics and advertising services. These services have their own privacy policies governing the use of information they collect.</p>
