...
export const gen9Pokemon: Pokemon[] = [
  ...
  {
    id: 999,
    // Two Gimmighoul encounter forms exist in Pokémon GO with different combat
    // stats (Chest Form is bulkier, ~121/122/128); this entry uses the more
    // common Roaming Form. A separate Chest Form entry may be added later.
  ...
  {
    id: 1009,
    // Not yet released in Pokémon GO as of Sept 2026; these are the current
    // pre-release GAME_MASTER stats (Niantic's client already has them
    // staged), best available figure but unconfirmed until it actually goes live.
    name: "Walking Wake",
    baseAttack: 233,
    baseDefense: 171,
    baseStamina: 203,
  ...
  {
    id: 1010,
    // Not yet released in Pokémon GO as of Sept 2026; see Walking Wake note above.
    name: "Iron Leaves",
    baseAttack: 236,
    baseDefense: 194,
    baseStamina: 189,
